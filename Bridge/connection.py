...
class clientsever:
    ...
    def getMotorHandle(self):
        ...
        for i in range(0, cf.dof):
            _, motor = self.client.simxGetObjectHandle('panda_joint'+str(i+1), self.client.simxServiceCall())
        ...
        self.client.simxGetJointPosition(self.motorHandle[6], self.client.simxDefaultSubscriber(self.joint7Callback))    
        ...
        self.client.simxGetObjectFloatParameter(self.motorHandle[6], 2012, self.client.simxDefaultSubscriber(self.jointdot7Callback))
    ...
    def jointdot6Callback(self, msg):
        self.qdot[5] = msg[1]
    def jointdot7Callback(self, msg):
        self.qdot[6] = msg[1]
